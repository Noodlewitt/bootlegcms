...
FileInput = ($input, options={}) ->
  ...
  @$clear_btn = $(FileInput.DEFAULTS.clear_btn_tmpl).addClass('pfi-clear').appendTo($('.pfi-actions', @$el))
  @$choose_btn = $(FileInput.DEFAULTS.choose_btn_tmpl).addClass('pfi-choose').appendTo($('.pfi-actions', @$el))
