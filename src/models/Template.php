...
class Template extends Baum\Node { //Eloquent {
    ...
    protected $fillable = ['name', 'identifier', 'position', 'parent_id', 'set_parent_id', 'user_id', 'deleted_at', 'service_provider', 'view', 'layout', 'content_type_id', 'application_id'];
    ...
    protected $scoped = ['application_id'];
