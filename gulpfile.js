...
gulp.task('uglify', function() {
    gulp.src([
        ...
        'public/components/bootstrap/js/bootstrap-alert.js',
        'public/components/bootstrap/js/bootstrap-modal.js',
        'public/components/bootstrap/js/bootstrap-tab.js',
        'public/components/bootstrap/js/bootstrap-dropdown.js',
        'public/components/bootstrap/js/bootstrap-collapse.js',
        'public/components/bootstrap/js/bootstrap-tooltip.js',
        'public/components/bootstrap/js/bootstrap-popover.js',
        'public/components/bootstrap/js/bootstrap-transition.js',
        ...
        'public/components/moment/min/moment-with-locales.js',
        'public/components/eonasdan-bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js',
        'public/components/bootstrap-sweetalert/lib/sweet-alert.min.js',
