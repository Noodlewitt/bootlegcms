...
<script>
    $('.add-row').click(function(e){
        ...
        $('.text-fields').append('<div class="input-group text"><input class="form-control" name="setting[ghfd][Contentsetting][]" type="text"><span class="input-group-btn"><button class="btn btn-danger" type="button"><span class="glyphicon glyphicon-remove"></span></button></span></div>');
    });
